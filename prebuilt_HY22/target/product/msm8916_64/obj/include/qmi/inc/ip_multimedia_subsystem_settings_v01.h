...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/imss/main/latest/api/ip_multimedia_subsystem_settings_v01.h#57 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define IMSS_V01_IDL_MINOR_VERS 0x29
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define IMSS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define IMSS_V01_MAX_MESSAGE_ID 0x0065
/**
    @}
  */
 ...
 */
  ...
  /**<   This value defines the 1x threshold value for comparing averaged signal strength
         Scenario: If the signal quality of 1x falls below iIMSHO1xQualTH and WiFi is available,
         the device shall de-register from 1x and connect to IMS PDN over WiFi for voice calls
		     Default Value --> -7 db
	*/
  ...
  /**<   This value defines LTE Threshold 3
         HandOver Scenario: WiFi to LTE and LTE to WiFi
         Used for in-call mode for Voice Only
  ...
  /**<   This value defines WiFi Threshold A
         HandOver Scenario: LTE to WiFi
         Used for in-call mode for Voice and Video
		     Default Value --> -85 db
	*/
  ...
  /**<   This value defines WiFi Threshold B
         HandOver Scenario: WiFi to LTE
         Used for in-call mode for Voice and Video
		     Default Value --> -95 db
	*/
...
/** Request Message; Sets the IMS application's VoLTE for Internet Connected Endpoint
             (VICE) configuration parameters for the requesting control point. */
typedef struct {
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Request Message; Retrieves the IMS application's VICE configuration parameters. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Response Message; Retrieves the IMS application's VICE configuration parameters. */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  ACS Network Configuration/RCS Configuration */
...
/** @addtogroup imss_qmi_messages
    @{
  */
/** Indication Message; Indicates when the RCS configuration parameters change. */
typedef struct {
