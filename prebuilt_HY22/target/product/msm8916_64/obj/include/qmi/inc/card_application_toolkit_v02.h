...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/cat/main/latest/api/card_application_toolkit_v02.h#34 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.2 
   It was generated on: Mon Jan 26 2015 (Spin 0)
...
#define CAT_V02_IDL_MINOR_VERS 0x1B
...
typedef struct {
  ...
  /**<   Event report request bitmask: \n
       ...
       - Bit 27 -- Contactless Support: including handling "Contactless 
                   State Changed" proactive command and Setup Event 
...
typedef struct {
  ...
  /**<   Contactless State Changed proactive command encoded as in \hyperref[S1]{[S1]}, Section 6.6.41.*/
...
typedef struct {
  ...
  */
  ...
  /**<   Contactless State Request (see \hyperref[S1]{[S1]}, Section 8.91).*/
