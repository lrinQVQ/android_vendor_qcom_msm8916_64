...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Sat Nov  7 2015 (Spin 0)
...
#define NAS_V01_IDL_MINOR_VERS 0x97
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00B5
/**
    @}
  */
...
typedef enum {
  ...
  NAS_EMM_REGISTERED_INITIATED_V01 = 2, /**<  REGISTERED_INITIATED \n  */
  NAS_EMM_REGISTERED_V01 = 3, /**<  REGISTERED \n  */
  NAS_EMM_TRACKING_AREA_UPDATING_INITIATED_V01 = 4, /**<  TRACKING_AREA_UPDATING_INITIATED \n  */
  NAS_EMM_SERVICE_REQUEST_INITIATED_V01 = 5, /**<  SERVICE_REQUEST_INITIATED \n  */
  NAS_EMM_DEREGISTERED_INITIATED_V01 = 6, /**<  DEREGISTERED_INITIATED \n  */
...
typedef enum {
  ...
  NAS_EMM_DEREGISTERED_NO_IMSI_V01 = 0, /**<  DEREGISTERED_NO_IMSI \n  */
  NAS_EMM_DEREGISTERED_PLMN_SEARCH_V01 = 1, /**<  DEREGISTERED_PLMN_SEARCH \n  */
  NAS_EMM_DEREGISTERED_ATTACH_NEEDED_V01 = 2, /**<  DEREGISTERED_ATTACH_NEEDED \n  */
  NAS_EMM_DEREGISTERED_NO_CELL_AVAILABLE_V01 = 3, /**<  DEREGISTERED_NO_CELL_AVAILABLE \n  */
  NAS_EMM_DEREGISTERED_ATTEMPTING_TO_ATTACH_V01 = 4, /**<  DEREGISTERED_ATTEMPTING_TO_ATTACH \n  */
  NAS_EMM_DEREGISTERED_NORMAL_SERVICE_V01 = 5, /**<  DEREGISTERED_NORMAL_SERVICE \n  */
  NAS_EMM_DEREGISTERED_LIMITED_SERVICE_V01 = 6, /**<  DEREGISTERED_LIMITED_SERVICE \n  */
  NAS_EMM_REGISTERED_NORMAL_SERVICE_V01 = 7, /**<  REGISTERED_NORMAL_SERVICE \n  */
  NAS_EMM_REGISTERED_UPDATE_NEEDED_V01 = 8, /**<  REGISTERED_UPDATE_NEEDED \n  */
  NAS_EMM_REGISTERED_ATTEMPTING_TO_UPDATE_V01 = 9, /**<  REGISTERED_ATTEMPTING_TO_UPDATE \n  */
  NAS_EMM_REGISTERED_NO_CELL_AVAILABLE_V01 = 10, /**<  REGISTERED_NO_CELL_AVAILABLE \n  */
  NAS_EMM_REGISTERED_PLMN_SEARCH_V01 = 11, /**<  REGISTERED_PLMN_SEARCH \n  */
  NAS_EMM_REGISTERED_LIMITED_SERVICE_V01 = 12, /**<  REGISTERED_LIMITED_SERVICE \n  */
  NAS_EMM_REGISTERED_ATTEMPTING_TO_UPDATE_MM_V01 = 13, /**<  REGISTERED_ATTEMPTING_TO_UPDATE_MM \n  */
  NAS_EMM_REGISTERED_IMSI_DETACH_INITIATED_V01 = 14, /**<  REGISTERED_IMSI_DETACH_INITIATED \n  */
  NAS_EMM_INTERNAL_SUBSTATE_V01 = 15, /**<  INTERNAL_SUBSTATE \n  */
...
typedef enum {
  ...
  LTE_UE_CATEGORY_DEFAULT_V01 = 0, 
  LTE_UE_CATEGORY_1_V01 = 1, 
  LTE_UE_CATEGORY_2_V01 = 2, 
  LTE_UE_CATEGORY_3_V01 = 3, 
  LTE_UE_CATEGORY_4_V01 = 4, 
  LTE_UE_CATEGORY_5_V01 = 5, 
  LTE_UE_CATEGORY_6_V01 = 6, 
  LTE_UE_CATEGORY_7_V01 = 7, 
  LTE_UE_CATEGORY_8_V01 = 8, 
  LTE_UE_CATEGORY_9_V01 = 9, 
  LTE_UE_CATEGORY_10_V01 = 10, 
  LTE_UE_CATEGORY_11_V01 = 11, 
  LTE_UE_CATEGORY_12_V01 = 12, 
  LTE_UE_CATEGORY_13_V01 = 13, 
  LTE_UE_CATEGORY_INVALID_V01 = 14, 
...
typedef struct {
  ...
  */
  ...
  /**<   NAS EMM state. Values: \n
      - NAS_EMM_NULL (0) --  NULL \n 
      - NAS_EMM_DEREGISTERED (1) --  DEREGISTERED \n 
      - NAS_EMM_REGISTERED_INITIATED (2) --  REGISTERED_INITIATED \n 
      - NAS_EMM_REGISTERED (3) --  REGISTERED \n 
      - NAS_EMM_TRACKING_AREA_UPDATING_INITIATED (4) --  TRACKING_AREA_UPDATING_INITIATED \n 
      - NAS_EMM_SERVICE_REQUEST_INITIATED (5) --  SERVICE_REQUEST_INITIATED \n 
      - NAS_EMM_DEREGISTERED_INITIATED (6) --  DEREGISTERED_INITIATED \n 
 */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API will allow to configure the cell list so that service 
              acquisition will be limited to these configured cells. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API will allow to configure the cell list so that service 
              acquisition will be limited to these configured cells. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API will allow to dynamically upgrade/downgrade 
              LTE UE category or enable/disable Carrier Aggregation or both. */
typedef struct {
  ...
  /**<   LTE UE Category.\n
      ...
      - LTE_UE_CATEGORY_8 (8) -- 
      - LTE_UE_CATEGORY_9 (9) -- 
      - LTE_UE_CATEGORY_10 (10) -- 
      - LTE_UE_CATEGORY_11 (11) -- 
      - LTE_UE_CATEGORY_12 (12) -- 
      - LTE_UE_CATEGORY_13 (13) -- 
      - LTE_UE_CATEGORY_INVALID (14) -- 
 */
  ...
  uint8_t disable_ca;
  /**<   Indicates whether Carrier Aggregation is disabled or not. 
       Values: \n
       - TRUE  -- Disabled \n
       - FALSE -- Enable
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API will allow to dynamically upgrade/downgrade 
              LTE UE category or enable/disable Carrier Aggregation or both. */
typedef struct {
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Indicates the timer ID which has expired. */
typedef struct {
...
typedef enum {
  ...
  NAS_EMERGENCY_MODE_STARTED_V01 = 0x01, /**<  Emergency Mode Started \n  */
  NAS_EMERGENCY_MODE_ENDED_V01 = 0x02, /**<  Emergency Mode Ended \n  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Indication Message; Indicates the status of emergency mode. */
typedef struct {
  ...
  /**<   Emergency Mode. Values: \n
      - NAS_EMERGENCY_MODE_STARTED (0x01) --  Emergency Mode Started \n 
      - NAS_EMERGENCY_MODE_ENDED (0x02) --  Emergency Mode Ended \n 
 */

  /* Optional */
  /*  Is ECBM is required on LTE */
  uint8_t is_ecbm_required_valid;  /**< Must be set to true if is_ecbm_required is being passed */
  uint8_t is_ecbm_required;
  /**<   Indicates whether LTE ECBM is required by NV setting.
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; API triggers deregistration operation for a ECall. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; API triggers deregistration operation for a ECall. */
typedef struct {
