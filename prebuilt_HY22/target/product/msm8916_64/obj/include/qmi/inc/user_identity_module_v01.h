...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/uim/main/latest/api/user_identity_module_v01.h#51 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.4
   It was generated on: Mon Apr 13 2015 (Spin 0)
...
#define UIM_V01_IDL_MINOR_VERS 0x31
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x005C
/**
    @}
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Resets the issuing control points state kept by the service. */
typedef struct {
...
typedef struct {
  ...
  /**<   Requested configurations:\n
       ...
       - Bit 3  -- USB UICC supported\n
       - Bit 4  -- Support for SAP in client mode\n
...
typedef struct {
  ...
  */
  ...
  /**<   Indicates if the modem is configured to support USB UICC feature.
       Valid values:\n
         - 0 -- Modem does not support USB UICC feature\n
         - 1 -- Modem supports USB UICC feature
  */
  ...
  /**<   Indicates if the modem is configured to support for SAP in client mode.
       Valid values:\n
         - 0 -- Modem does not support for SAP in client mode\n
         - 1 -- Modem supports for SAP in client mode
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Performs GBA initalization procedure and generates a key shared with a NAF */
typedef struct {
  ...
  /**<   Even if key in the GBA module is still valid, rerun the GBA procedure
       and overwrite existing Ks.
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Performs GBA initalization procedure and generates a key shared with a NAF */
typedef struct {
  ...
  */
  ...
  /**<   Key shared between the NAF and the ME. Derivation of the Key
       is specified in TS33.220
  */

  /* Optional */
  /*  Encrypted Ks NAF (GBA_ME) */
  ...
  /**<   Encrypted value of Ks_NAF, as specified in TS 33.220. */
  ...
  /**<   ID that binds the subscriber identity to the keying material.
       The formatting of the B-TID can be found in TS33.220.
  */
  ...
  /**<   The lifetime of the BSF generated key material. Lifetime is expressed
       in UTC form with the tailing character indicating timezone.
       [reference ISO 8601 for time formatting]
  */
  ...
  /**<   The private user identity used for GBA procedure as specified in TS 33.220.*/
...
typedef struct {
  ...
  */
  ...
  uint32_t encrypted_ks_naf_len;  /**< Must be set to # of elements in encrypted_ks_naf */
  uint8_t encrypted_ks_naf[QMI_UIM_ENCRYPTED_KS_NAF_MAX_V01];
  /**<   Encrypted version of the shared key between the NAF and the ME.
       Encryption of the data is know only to the Modem and the trusted
       application entity. Derivation of the Key is specified in TS33.220
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Retrieves the IMPI used for GBA corresponding to the session */
typedef struct {
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Retrieves the IMPI used for GBA corresponding to the session */
typedef struct {
...
typedef enum {
  ...
  UIM_SEARCH_FORWARD_V01 = 0x00, /**<  Forward Search\n  */
...
typedef struct {
  ...
  /**<   Indicates the direction in which the pattern search proceed starting
 from record. Valid values:\n
      - UIM_SEARCH_FORWARD (0x00) --  Forward Search\n
      - UIM_SEARCH_BACKWARD (0x01) --  Backward Search
 \n
 Other values are reserved for future use.
 Default value is FORWARD in case TLV is not present.
 */

  uint8_t first_record;
  /**<   Record number (starting from 1) from where the search will start.
       Default value is 1 in case TLV is not present.
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Request Message; Provides access to search for records in the card
...
typedef struct {
  ...
  /**<   Pattern content to perform search in the file for all possible records.*/
  ...
  /**<   When this TLV is absent, use dafault values for search_type
       and first_record.
  */
...
/** @addtogroup uim_qmi_messages
    @{
  */
/** Response Message; Provides access to search for records in the card
           with the given pattern. */
typedef struct {
  ...
  */
  ...
  /**<   Search content. Content is the list with numbers of the records
       matching the patterns in the request.
  */
