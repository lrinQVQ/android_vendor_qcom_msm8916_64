 ...
 ********************************************************************************
 */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acph/inc/acph.h#16 $ */
/*
   --------------------
   |include files                |
   --------------------
...
typedef enum AcdbCodecChipsetVersion{
   VERSION_1_0 = 1,
   VERSION_2_0 = 2
} AcdbCodecChipsetVersion;
...
struct  ADIE_CODEC_HANDLE{
      ...
      uint32_t  chipset_version;            /**< Codec Chipset version of type AcdbCodecChipsetVersion.  */
}
