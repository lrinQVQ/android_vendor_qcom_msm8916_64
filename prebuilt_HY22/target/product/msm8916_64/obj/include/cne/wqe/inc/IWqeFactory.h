...
public:
   ...
   *--------------------------------------------------------------------------*/
   ...
   //TODO: Create an overloaded createWqeAgent function that does not have overrides
   //parameter. Convert the overrides parameter to a reference instead of ptr
   virtual IWqeAgent* createWqeAgent(std::string profileType, CneTimer &timer, CneCom &com, const CQEClientOverrides *overrides = NULL);
...
private:
   ...
   * -------------------------------------------------------------------------*/
   ...
   //SwimBitrateEstimator *bqeEngine;
