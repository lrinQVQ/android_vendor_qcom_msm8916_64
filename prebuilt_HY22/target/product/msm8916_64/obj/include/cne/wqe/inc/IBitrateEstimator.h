...
//TODO: move to a common location, does not belong to this file.
typedef enum SwimDefaultInterfaceSelectorEvent_e {
  ...
  CNE_NIMS_INVALIDATE_ICD_HISTORY
...
public:
   ...
   * SIDE EFFECTS  None
   *--------------------------------------------------------------------------*/
  virtual void InitializeLinks(SwimNetlinkSocket *a_nl) = 0;
...
//      SwimBQEResultCb_t bqeResultCb, void *udata) = 0;
  ...
  //virtual void updateIcdOutcome(bool icdPass)=0;
