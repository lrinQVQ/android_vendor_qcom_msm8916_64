...
public:
   ...
   * DEPENDENCIES  parcel
   *
   * RETURN VALUE  p will contain the parceled data
   *
   * SIDE EFFECTS  none
   *--------------------------------------------------------------------------*/
 ...
 * FUNCTION      parcel
 *
 * DESCRIPTION   parcel a cne_rat_type
 *               params:
 *                 data - the data to be parceled
 *                 p - an empty parcel to be populated
 *
 ...
 * SIDE EFFECTS  none
 *--------------------------------------------------------------------------*/
  static void parcel(cne_rat_type const& data, android::Parcel &p);

 /*----------------------------------------------------------------------------
  * FUNCTION      parcel
  *
  * DESCRIPTION   parcel a CneNatKeepAliveRequestInfo
  *               params:
  *                 data - the data to be parceled
  *                 p - an empty parcel to be populated
  *
  ...
  * SIDE EFFECTS  none
  *--------------------------------------------------------------------------*/
  static void parcel(CneNatKeepAliveRequestInfo const& data, android::Parcel &p);
 ...
 static void unparcel(android::Parcel &p, CneWlanFamType &data);
   ...
   * FUNCTION      unparcel
   *
   * DESCRIPTION   unparcel a CneRatInfoType
   *               params:
   *                 p - the parcel to be unparceled
   *                 data - the data structure to be populated
   *
   ...
   * SIDE EFFECTS  none
   *--------------------------------------------------------------------------*/
 static void unparcel(android::Parcel &p, CneRatInfoType &data);

  /*----------------------------------------------------------------------------
   * FUNCTION      unparcel
   *
   * DESCRIPTION   unparcel a CneNatKeepAliveResultInfo
   *               params:
   *                 p - the parcel to be unparceled
   *                 data - the data structure to be populated
   *
   ...
   * SIDE EFFECTS  none
   *--------------------------------------------------------------------------*/
 static void unparcel(android::Parcel &p, CneNatKeepAliveResultInfo &data);

  /*----------------------------------------------------------------------------
   * FUNCTION      unparcel
   *
   * DESCRIPTION   unparcel a CneQuotaInfo
   *               params:
   *                 p - the parcel to be unparceled
   *                 data - the data structure to be populated
   *
   ...
   * SIDE EFFECTS  none
   *--------------------------------------------------------------------------*/
 static void unparcel(android::Parcel &p, CneQuotaInfo &data);

 /*----------------------------------------------------------------------------
   * FUNCTION      unparcel
   *
   * DESCRIPTION   unparcel a MobileDataState
   *               params:
   *                 p - the parcel to be unparceled
   *                 data - the data structure to be populated
   *
   ...
   * SIDE EFFECTS  none
   *--------------------------------------------------------------------------*/
 static void unparcel(android::Parcel &p, MobileDataState &data);
